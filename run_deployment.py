...
def main(config: str, min_accuracy: float):
    ...
    if deploy:
        continuous_deployment_pipeline(
            data_path= "/mnt/c/Users/hp/Downloads/Artificial Intelligence/MLOPS/Ubuntu/customer-satisfaction/data/olist_customers_dataset.csv",
    ...
    # fetch existing services wieth same pipeline step name and model name
    print(
        "You can run:\n"
